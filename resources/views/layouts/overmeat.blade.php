    ...
    <style>
        ...
        * {
        ...
        .menu-hero-watermark {
            ...
            width: 400px;
            opacity: 0.04;
            /* شفافية عالية جداً لتكون خلفية */
            z-index: 1;
            pointer-events: none;
        }

        .menu-hero-watermark img {
            width: 100%;
        ...
        /* تأثير النشاط والتحويم */
        .visual-cat-card:hover img,
        .visual-cat-card.active img {
            transform: scale(1.1);
        }
        ...
        .visual-cat-card.active .visual-cat-overlay {
            background: linear-gradient(to top, rgba(212, 175, 55, 0.4) 0%, rgba(0, 0, 0, 0.2) 60%, transparent 100%);
        }
        ...
        .menu-luxury-item:hover .menu-luxury-img-box img {
        ...
        .menu-luxury-price .new-price {
            color: #4ade80;
        }

        .menu-luxury-details p {
            color: #888;
            font-size: 0.95rem;
            line-height: 1.6;
        }
        ...
        [dir="rtl"] .luxury-footer-title::after {
            left: auto;
            right: 0;
        }
        ...
        [dir="rtl"] .luxury-footer-links a:hover {
            padding-left: 0;
            padding-right: 10px;
        }
...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="container nav-container">
            ...
            <ul class="nav-links" id="nav-links">
                <li><a href="{{ url('/') }}#home" class="nav-link" data-lang="nav_home">Home</a></li>
                <li><a href="{{ url('/') }}#about" class="nav-link" data-lang="nav_about">About</a></li>
                <li><a href="{{ route('menu') }}" class="nav-link" data-lang="nav_menu">Menu</a></li>
                <li><a href="{{ url('/') }}#gallery" class="nav-link" data-lang="nav_gallery">Gallery</a></li>
                <li><a href="{{ url('/') }}#reservation" class="nav-link" data-lang="nav_reservation">Book</a></li>
                <li><a href="{{ url('/') }}#contact" class="nav-link" data-lang="nav_contact">Contact</a></li>
                <li>
    ...
    <footer class="luxury-footer">
        <div class="luxury-footer-glow"></div>

        <div class="container">
            <div class="luxury-footer-grid">

                <div class="luxury-footer-col">
                    <div class="luxury-footer-logo">
                        @if($setting->logo)
                        <img src="{{ asset('storage/' . $setting->logo) }}" alt="Logo">
                        @endif
                        <span>{{ $setting->site_name ?? 'AURUM' }}</span>
                    </div>
                    <p class="luxury-footer-desc" data-content-en="An extraordinary culinary journey where luxury meets the art of cooking." data-content-ar="رحلة طهي استثنائية حيث تلتقي الفخامة بفن الطبخ.">
                        An extraordinary culinary journey where luxury meets the art of cooking.
                    </p>

                    <a href="{{ $setting->google_review_link ?? '#' }}" target="_blank" class="google-review-btn">
                        <i class="fab fa-google"></i>
                        <span data-lang="footer_review_btn">Rate us on Google</span>
                        <i class="fas fa-external-link-alt"></i>
                    </a>
                </div>

                <div class="luxury-footer-col">
                    <h4 class="luxury-footer-title" data-lang="footer_pages">Quick Links</h4>
                    <ul class="luxury-footer-links">
                        <li><a href="{{ url('/') }}#home" data-lang="nav_home">Home</a></li>
                        <li><a href="{{ url('/') }}#about" data-lang="nav_about">About</a></li>
                        <li><a href="{{ route('menu') }}" data-lang="nav_menu">Menu</a></li>
                        <li><a href="{{ url('/') }}#reservation" data-lang="nav_reservation">Book</a></li>
                        <li><a href="{{ url('/') }}#contact" data-lang="nav_contact">Contact</a></li>
                        <li><a href="{{ url('/') }}#faq">FAQ</a></li>
                    </ul>
                </div>

                <div class="luxury-footer-col">
                    <h4 class="luxury-footer-title" data-lang="footer_categories">Our Menu</h4>
                    <ul class="luxury-footer-links">
                        @forelse($categories ?? [] as $cat)
                        <li>
                            <a href="{{ route('menu') }}"
                                data-content-en="{{ $cat->name_en }}"
                                data-content-ar="{{ $cat->name_ar }}">
                                {{ $cat->name_en }}
                            </a>
                        </li>
                        @empty
                        <li><a href="#" data-lang="filter_starters">Starters</a></li>
                        <li><a href="#" data-lang="filter_mains">Mains</a></li>
                        <li><a href="#" data-lang="filter_desserts">Desserts</a></li>
                        @endforelse
                    </ul>
                </div>

                <!-- العمود الرابع: التواصل والسوشيال -->
                <div class="luxury-footer-col">
                    <h4 class="luxury-footer-title" data-lang="footer_contact">Contact Us</h4>
                    <ul class="luxury-footer-contact">
                        <li>
                            <i class="fas fa-map-marker-alt"></i>
                            <span data-content-en="{{ $setting->address_en }}" data-content-ar="{{ $setting->address_ar }}">{{ $setting->address_en }}</span>
                        </li>
                        <li>
                            <i class="fas fa-phone"></i>
                            <a href="tel:{{ $setting->mobile }}" dir="ltr">{{ $setting->mobile }}</a>
                        </li>
                        <li>
                    ...
                    <div class="luxury-footer-social">
                        ...
                        @if($setting->twitter)<a href="{{ $setting->twitter }}" target="_blank"><i class="fab fa-twitter"></i></a>@endif
                        @if($setting->tiktok)<a href="{{ $setting->tiktok }}" target="_blank"><i class="fab fa-tiktok"></i></a>@endif
                    </div>
                </div>
            </div>
            ...
            <div class="luxury-footer-bottom">
                <p>&copy; {{ date('Y') }} {{ $setting->site_name ?? 'Aurum' }}. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
    <!-- Toast Notification -->
    ...
    <script>
        ...
        const translations = {
            en: {
                ...
                menu_hero_subtitle: "A Symphony of Flavors",
                filter_all: "All",
                footer_review_btn: "Rate us on Google",
            ...
            ar: {
                ...
                menu_hero_title: "قائمة الطعام",
                menu_hero_subtitle: "سيمفونية من النكهات",
                filter_all: "الكل",
                footer_review_btn: "قيمنا على جوجل",
